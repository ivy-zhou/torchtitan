...
from torchtitan.components.checkpointer.base import MODEL, ModelWrapper, purge_worker
...
class TestCheckpointManager(unittest.TestCase):
    ...
    @mock.patch("torchtitan.components.checkpointer.dcp.dcp.save")
    ...
    @mock.patch(
        "torchtitan.components.checkpointer.dcp.dcp.async_save",
